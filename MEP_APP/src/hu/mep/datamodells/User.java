...
/** This class represent the user, after successful login.
 * After authorization we get back a JSON file, which from we can get the next attributes by the given names.
 * 
 * mepID is coming from JSON attribute "mep_id"
 * fullName is coming from JSON attribute "nev"
 * usersPlaces is coming from JSON attribute "tavfelugyeletek"
 * mekut is coming from JSON attribute "mekut"
 * teacher is coming from JSON attribute "tanar"
 * moderator is coming from JSON attribute "moderator"
 * 
 * @author Tibor, Török
 */
public class User {
